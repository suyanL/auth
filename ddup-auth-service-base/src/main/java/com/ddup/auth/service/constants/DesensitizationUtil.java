...
public class DesensitizationUtil {
	...
	public static String around(String name, int index, int end) {
		...
		return StringUtils.left(name, index).concat(
				StringUtils.removeStart(StringUtils.leftPad(StringUtils.right(name, end),
	...
	public static String idPassport(String id) {
		...
		return id.substring(0, 2)
				+ new String(new char[id.length() - 5]).replace("\0", "*")
	 ...
	 * 证件后几位脱敏
	 * @param id id
	 * @param sensitiveSize sensitiveSize
	 * @return return
	 */
